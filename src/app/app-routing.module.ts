...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'kpi-update/:id', component: KpiUpdateComponent },
      { path: 'kpi-add', component: KpiAddComponent },
      ...
      {
        path: 'add-thoroughbred',
        loadChildren: () => import('./admin/module/thoroughbred/add-thoroughbred/add-thoroughbred.module').then(m => m.AddThoroughbredModule),
        canActivate: [AuthGuard]
      },
      {
        path: 'list-thoroughbred',
        loadChildren: () => import('./admin/module/thoroughbred/list-thoroughbred/list-thoroughbred.module').then(m => m.ListThoroughbredModule),
        canActivate: [AuthGuard]
      },
      {
        path: 'update-thoroughbred/:id',
        loadChildren: () => import('./admin/module/thoroughbred/update-thoroughbred/update-thoroughbred.module').then(m => m.UpdateThoroughbredModule),
        canActivate: [AuthGuard]
      },
      {
